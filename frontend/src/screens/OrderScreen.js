...
const OrderScreen = ({ history, match }) => {
  ...
  if(!loading) {
    ...
    order.itemsPrice = addDecimals(order.orderItems.reduce((acc, curItem) => acc + curItem.price * curItem.qty, 0))
  }
  ...
  }, [orderId, dispatch, history, successPay, successDeliver, order, userInfo])
